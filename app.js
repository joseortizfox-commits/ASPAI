...
try{
  ...
  function extraRecipesBolleria1(){
    return [
      { name:'Croissant',
        notes:'Base: 1 kg de harina (750 g GF + 250 g Nova). "1 PAST" = un pastón de 2 kg de harina; el resto de columnas de la foto original son múltiplos exactos de esa base, así que no hace falta transcribirlas — usa el escalador de la Calculadora.\n\n'+
          'Importante: la cantidad de mantequilla de laminado (la que se incorpora al plegar, distinta de los 100 g de "Mante" de la masa) no venía especificada en la ficha original — añade la que uses habitualmente (orientativamente, un 40-50% del peso de la masa) y ajusta esta nota.\n\n'+
          'Formato de corte: croissants de 160/170 mm de largo con base de 10 cm. Bandeja: 12 uds por lata.',
